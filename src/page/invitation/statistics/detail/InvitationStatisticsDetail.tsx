...
function InvitationStatisticsDetail() {
    ...
    return (
        <Column
            ...
            style={{width: 867, paddingTop: 64, paddingBottom: 120, paddingLeft: 64, overflowY: 'scroll'}}
        >
            <Icon
                        ...
                        <Column gap={32} $alignItems={'stretch'}>
                            <Column gap={8} $alignItems={'stretch'}>
                                ...
                                <Column gap={8}
                                    ...
                                    <Line data={makeData(weddingStatistics.weddingStatisticsInfos)} options={options}/>
                                </Column>
                            </Column>
                            <Column gap={8} $alignItems={'stretch'}>
                            ...
                            <Column gap={8} $alignItems={'stretch'}>
                                ...
                                {wedding.rsvp.attendMealStatus ? (
                                    ...
                                    <Row $alignItems={'center'} $justifyContent={'center'} gap={8} padding={'48px 0'}
                                         style={{
